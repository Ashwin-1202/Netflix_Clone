...
(function (a) {
  ...
  var a = function (k) {
    var l = [];
    var j = false;
    var i = k.dir && k.dir === "left" ? "scrollLeft" : "scrollTop";
    this.each(function () {
      var m = d(this);
      ...
      if (
        ...
        l.push(document.scrollingElement);
        return false;
      }
      if (m[i]() > 0) {
        l.push(this);
    ...
    if (!l.length) {
      this.each(function () {
        if (
          ...
          d(this).css("scrollBehavior") === "smooth"
        ) {
          l = [this];
        }
        if (!l.length && this.nodeName === "BODY") {
          l = [this];
        }
      });
    }
    if (k.el === "first" && l.length > 1) {
      l = [l[0]];
    }
    return l;
  };
  ...
  d.fn.extend({
    scrollable: function (i) {
      var j = a.call(this, { dir: i });
      return this.pushStack(j);
    },
    firstScrollable: function (i) {
      var j = a.call(this, { el: "first", dir: i });
      return this.pushStack(j);
    },
    smoothScroll: function (j, i) {
      j = j || {};
      if (j === "options") {
        if (!i) {
        ...
        return this.each(function () {
          var n = d(this);
          var m = d.extend(n.data("ssOpts") || {}, i);
          d(this).data("ssOpts", m);
        });
      }
      var k = d.extend({}, d.fn.smoothScroll.defaults, j);
      var l = function (p) {
        var y = function (C) {
        ...
        var z = this;
        var x = d(this);
        var r = d.extend({}, k, x.data("ssOpts") || {});
        var q = k.exclude;
        var v = r.excludeWithin;
        var A = 0;
        var t = 0;
        var o = true;
        var B = {};
        var n = d.smoothScroll.filterPath(location.pathname);
        var u = d.smoothScroll.filterPath(z.pathname);
        var s = location.hostname === z.hostname || !z.hostname;
        var m = r.scrollTarget || u === n;
        var w = y(z.hash);
        if (w && !d(w).length) {
          o = false;
        }
        if (!r.scrollTarget && (!s || !m || !w)) {
          o = false;
        } else {
          while (o && A < q.length) {
            if (x.is(y(q[A++]))) {
        ...
        if (o) {
          ...
          d.extend(B, r, { scrollTarget: r.scrollTarget || w, link: z });
          d.smoothScroll(B);
        }
      };
      if (j.delegateSelector !== null) {
        this.off("click.smoothscroll", j.delegateSelector).on(
          "click.smoothscroll",
          j.delegateSelector,
          l,
        );
      } else {
        this.off("click.smoothscroll").on("click.smoothscroll", l);
      }
      return this;
    },
  });
  var h = function (k) {
    var i = { relative: "" };
    var j = typeof k === "string" && c.exec(k);
    if (typeof k === "number") {
      i.px = k;
    } else {
      if (j) {
        i.relative = j[1];
        i.px = parseFloat(j[2]) || 0;
      }
    }
    return i;
  };
  var g = function (j) {
    var i = d(j.scrollTarget);
    if (j.autoFocus && i.length) {
      i[0].focus();
    ...
    j.afterScroll.call(j.link, j);
  };
  d.smoothScroll = function (u, p) {
    if (u === "options" && typeof p === "object") {
      return d.extend(f, p);
    }
    var i, j, k, q;
    var m = h(u);
    ...
    var n = {};
    if (m.px) {
      i = d.extend({ link: null }, d.fn.smoothScroll.defaults, f);
    } else {
      i = d.extend({ link: null }, d.fn.smoothScroll.defaults, u || {}, f);
      if (i.scrollElement) {
        l = "position";
    ...
    o = i.direction === "left" ? "scrollLeft" : o;
    if (i.scrollElement) {
      j = i.scrollElement;
      if (!m.px && !/^(?:HTML|BODY)$/.test(j[0].nodeName)) {
        s = j[o]();
      }
    } else {
      j = d("html, body").firstScrollable(i.direction);
    }
    i.beforeScroll.call(j, i);
    t = m.px
      ? m
      : {
          relative: "",
          px:
            (d(i.scrollTarget)[l]() && d(i.scrollTarget)[l]()[i.direction]) ||
            0,
        };
    r[o] = t.relative + (t.px + s + i.offset);
    k = i.speed;
    if (k === "auto") {
      q = Math.abs(r[o] - j[o]());
      k = q / i.autoCoefficient;
    }
    n = {
      duration: k,
      easing: i.easing,
  ...
  d.smoothScroll.version = b;
  d.smoothScroll.filterPath = function (i) {
    i = i || "";
    return i
      .replace(/^\//, "")
